...
namespace AndressaPage.Models
{

    public class EmployeeDAL
    {
       const string serverName = "aoyuge\\SQLEXPRESS";

        string connectionString = $"Data Source=" + serverName + ";Database=EMPLOYEEDB;Trusted_Connection=True";
